...
6. Create an account on [Discord](https://discord.com) if you don't have one already. The principles of making chat bots are the same regardless of platform, but Discord has especially nice support for this.
