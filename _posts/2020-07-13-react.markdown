...
We're done with our Course component, at this point your `Course.jsx` file should be:
...
You can find the final code on [Github](https://github.com/harsh183/gpa-cat-calc).
