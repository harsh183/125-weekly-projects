...
```
$ ls
__pycache__  fgit.py  file3.txt  log.txt  requirements.txt  test_folder
```

Using `plumbum.cmd` we can import commands from the command line and use it within python. Lets use this as a chance to show off red-green-refactor. 
