...
[...]
files = get_files()
question = questionary.select("What would you like to commit?", choices=files)
to_add = question.ask()
```

Check out the [questionary documentaiton](https://questionary.readthedocs.io/en/stable/pages/types.html#) for more information.
