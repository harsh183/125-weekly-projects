...
```
In line one we are declaring the lines we want to use. In line two we declare the rendering we want to use. In line 3 we can just blit it on to the screen.
